...
public class JoystickEditor : Editor
{
    ...
    {
        if (serializedObject.FindProperty("handleRange") != null) handleRange = serializedObject.FindProperty("handleRange");
        if (serializedObject.FindProperty("deadZone") != null) deadZone = serializedObject.FindProperty("deadZone");
        if (serializedObject.FindProperty("axisOptions") != null) axisOptions = serializedObject.FindProperty("axisOptions");
        if (serializedObject.FindProperty("snapX") != null) snapX = serializedObject.FindProperty("snapX");
        if (serializedObject.FindProperty("snapY") != null) snapY = serializedObject.FindProperty("snapY");
        if (serializedObject.FindProperty("background") != null) background = serializedObject.FindProperty("background");
        if (serializedObject.FindProperty("handle") != null) handle = serializedObject.FindProperty("handle");
    }
